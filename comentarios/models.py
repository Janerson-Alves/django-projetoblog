...
class Comentario(models.Model):
    ...
    post_comentario = models.ForeignKey(Post, on_delete=models.CASCADE, verbose_name='post Comentarios')
    usuario_comentario = models.ForeignKey(User, on_delete=models.DO_NOTHING, verbose_name='Usuario comentario')
